...
module.exports = {
  ...
  buildUseRestriction: function (data852, data876, customerCode) {
    ...
    if (['4', 'a', 'p'].indexOf(data876.o.toString()) !== -1) {
      if ([211, 212, 210, 214, 215, 217, 227].indexOf(parseInt(data876.s)) !== -1) {
